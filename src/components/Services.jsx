          ...
          >
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto ">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Deepchill® is like no other ice technology. It comprises of tiny
                pearl-like micro-crystals generated in sea, or fresh water,
                delivered in liquid slurry or crystal form to superchill and
                hold valuable product at peak freshness.
              </p>
              <ul className="body-2">
